...
import { AuthorizeNode, AuthorizeNodeDef } from "./modules/types";
...
const nodeInit: NodeInitializer = (RED): void => {
  function AuthorizeNodeConstructor(
    this: AuthorizeNode,
    config: AuthorizeNodeDef
  ): void {
    ...
    RED.httpAdmin.get('/spotify-credentials/auth', function (req, res) {
        ...
        const credentials: SpotifyApiCredentials = {
    ...
    RED.httpAdmin.get('/spotify-credentials/auth/callback', function (req, res) {
        ...
        const credentials: SpotifyApiCredentials = RED.nodes.getCredentials(node_id);
  ...
  RED.nodes.registerType("authorize", AuthorizeNodeConstructor);
};
